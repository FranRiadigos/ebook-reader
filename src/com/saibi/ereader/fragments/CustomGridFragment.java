...
public class CustomGridFragment extends Fragment {
	 ...
	 * be shown when the grid is empty.
	 * 
	 * <p>
	 ...
	 * 
	 * @param g
	 *            The {@link GridView} where the click happened
	 * @param v
	 *            The view that was clicked within the {@link GridView}
	 * @param position
	...
	/**
	 * Seter for custom grid view resource
	 * 
	 * @param resource
	 */
	public void setCustomGridView(int resource) {
		mCustomGridView = (GridView) getActivity().getLayoutInflater().inflate(
				resource, null);
	}

	/**
	 * Seter for custom grid view
	 * 
	 * @param view
	 */
	public void setCustomGridView(GridView view) {
		mCustomGridView = view;
	}
	 ...
	 * {@link #setGridAdapter(ListAdapter)}. If the grid at that point had not
